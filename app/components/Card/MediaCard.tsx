  ...
  return (
    <div className="flex justify-center">
      ...
      <video
        ...
        preload="metadata"
      />
      <div className="flex justify-evenly md:justify-between text-xl font-semibold">
        <p >Core Glow</p>
        <p>USDT 28,900</p>
      </div>
      <div className="flex justify-evenly md:justify-between text-xs font-semibold mt-5">
